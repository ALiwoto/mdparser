...
func TestCloneProvidesLegacyCopyStyleMigrationPath(t *testing.T) {
	cases := []struct {
		...
		{name: "styled", call: func(m WMarkDown) WMarkDown { return m.Clone().Styled("text", StyleBold, StyleItalic) }, want: "base*_text_*"},
		{name: "styled-underline-italic", call: func(m WMarkDown) WMarkDown { return m.Clone().Styled("text", StyleUnderline, StyleItalic) }, want: "base___text_\r__"},
...
func TestFormattingMethodsMutateReceiver(t *testing.T) {
	cases := []struct {
		...
		{name: "styled", call: func(m *wotoMarkDown) WMarkDown { return m.Styled("text", StyleBold, StyleItalic) }, want: "base*_text_*"},
		{name: "styled-empty-styles", call: func(m *wotoMarkDown) WMarkDown { return m.Styled("text") }, want: "basetext"},
